...
public class FingerprintAuthenticationDialogFragment extends DialogFragment implements FingerprintCallback {
    ...
    public static boolean isHardwareDetected = false;
    ...
    private String content = "Confirm fingerprint to continue";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFingerprintUiHelperBuilder = new FingerprintUiHelper.FingerprintUiHelperBuilder((FingerprintManager)mActivity.getSystemService(Context.FINGERPRINT_SERVICE));
    ...
    public boolean initCipher() {
        try {
            ...
            Log.d(TAG, "initCipher() : " + e.getMessage());
            return false;
        }
    }
    ...
    public void createKey() {
        ...
        try {
            ...
            Log.d(TAG, "createKey() : " + e.getMessage());
        }
    }
